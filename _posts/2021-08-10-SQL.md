...
> [GCP Dashboard](https://console.cloud.google.com/home/dashboard?project=utopian-surface-268707 "Google Cloud Platform Home"){:target="_blank"}
>
> [SQL Language basic functions](https://cloud.google.com/bigquery/docs/reference/standard-sql/aggregate_analytic_functions " Aggregate analytic functions in Standard SQL"){:target="_blank"}
