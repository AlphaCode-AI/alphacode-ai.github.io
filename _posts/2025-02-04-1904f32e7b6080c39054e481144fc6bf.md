...
category: Report
summary: |-
    최근 IT 업계에서는 저비용 AI 기술과 오픈소스 모델이 혁신의 중심에 서 있습니다. UC 버클리의 오픈소스 AI 모델 'Sky-T1-32B'는 저비용으로도 고성능을 실현해 AI 연구의 민주화를 이끌고 있습니다.

    AI의 생명과학 분야 활용도 돋보이는데, 서울대 연구팀은 AI로 항암 효소를 발굴했습니다. 반면, 한국의 AI 산업 경쟁력 강화를 위한 대규모 투자의 중요성도 대두되고 있습니다.

    구글의 '트랜스포머 2.0' 모델 '타이탄즈'는 AI의 인지 능력 향상에 기여할 전망입니다. 더 깊이 있는 내용을 확인하고 싶다면 아래 링크들을 통해 알아보세요.

    자세한 내용을 보고 싶으면 [여기](https://news.hada.io/topic?id=18560)를 통해 확인해보세요.
layout: post
published: true
---
